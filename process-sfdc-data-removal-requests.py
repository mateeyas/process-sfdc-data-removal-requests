...
def main():
    try:
        ...
        # %%
        # Load requests
        answer_requests = input("Do you have a list of OneTrust requests to process? (y/n) ")
        if answer_requests.lower() in ["y","yes"]:
            # %%
            # Load requests
            root = tk.Tk()
            root.withdraw()
        ...
        # %%
        # Load email list
        answer_requests = input("Do you have a TXT file containing a list of email addresses to process? (y/n) ")
        if answer_requests.lower() in ["y","yes"]:
            # %%
            # Get lists of email addresses
            root = tk.Tk()
        ...
        # %%
        # Start deletion
        answer_deletion = input("Do you want to delete the flagged contacts and accounts? (y/n) ")
        if answer_deletion.lower() in ["y","yes"]:
            # %%
            # Query cases
